...
const listItems = ['Compartilhar', 'Atualizar', 'Recarregar']
      ...
      <CardContent className='flex flex-1 flex-col gap-4'>
        <div className='flex flex-col gap-1'>
          <div className='flex items-center gap-2'>
            <span className='text-2xl font-semibold'>{earning.toLocaleString('pt-BR')} contatos</span>
              ...
              <div className='flex items-center justify-between gap-2.5'>
                <Avatar className='size-11 rounded-sm'>
                  <AvatarFallback className='bg-primary/10 shrink-0 rounded-sm'>
                    <img src={item.img} alt={item.platform} className='size-6' />
                  </AvatarFallback>
                </Avatar>
                <div className='flex flex-col gap-1'>
                  <span className='font-medium'>{item.platform}</span>
                  <span className='text-muted-foreground text-sm'>{item.technologies}</span>
                </div>
              </div>
